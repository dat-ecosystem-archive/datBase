...
module.exports = function (state, prev, send) {
  ...
  <section class="section bg-white">
    ...
    <div class="container container--narrow">
      ...
      <p>In the winter of 2016, the <a href="http://datproject.org/blog/2016-02-01-announcing-publicbits">Knight Foundation provided significant funding to create a registry for Dat-hosted datasets</a>, as well as enabling the project to grow and establish a 501(c)(3) non-profit.</p>
    </div>
  </section>
