...
<section class="section bg-neutral color-white">
  <div class="container">
    ...
    <p class="content-subtitle horizontal-rule">
      Dat is built within a vibrant open source module-based ecosystem. <a href="https://datproject.org/paper" class="color-blue-disabled hover-color-pink">Read the paper.</a>
    </p>
    <div class="row pv4">
