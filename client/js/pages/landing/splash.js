...
module.exports = function (state, prev, send) {
  return html`
    ...
    <div class="container">
      ...
      <p class="tc center measure">
        Share and manage your data with ease. Dat Desktop gives a clean and simple interface to secure, fast and distributed data sharing.
      </p>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
          <div class="example">
            ...
            <div class="example-footer">
              <a href="/dat/bf37b184c981c3db293f20530cd6461e39f8147c221b1e3ee03e08ef2b747547" class="fr btn btn--green open-desktop">
                Preview
              </a>
  ...
  <section class="section">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-6 flex flex-column justify-center">
          <h2 class="content-title horizontal-rule">
             Data sharing with Dat CLI
          </h2>
          <p class="measure mb4">
            Dat is the package manager for data.
            Easily share and version control data using our powerful command line tool and javascript library. Secure, distributed, fast.
          </p>
          <p>
            <a href="/install" class="btn btn--green btn px3" target="_blank">
              Install Dat CLI
            </a>
          </p>
          <p class="f6">
